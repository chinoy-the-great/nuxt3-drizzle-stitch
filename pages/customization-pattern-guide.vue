<template>
	<div>
		...
		<!-- header -->
		<div class="relative z-0 header py-4 text-center px-4">
...
// supply name + exact image filename (from /public)
const patternsByType: Record<string, { name: string; src: string }[]> = {
	Tops: [
		{ name: 'Shortsleeves', src: 'GuideTop_TShirt.png' },
