export const quizzesData = [
	...
	},
	{
		...
		answers: [
			{ text: 'A. Holds the fabric in place and moves it\n' + '\n' + 'evenly under the needle.', id: 1 },
			{ text: 'B. Adjusts thread tightness for smooth\n' + '\n' + 'stitching.', id: 2 },
			{ text: 'C. Catches the upper thread and forms a\n' + '\n' + 'stitch with the bobbin thread.', id: 3 },
			{ text: 'D. Controls the flow and tension of the\n' + '\n' + 'upper thread during stitching.', id: 4 },
			{ text: 'E. Protects the bobbin and other internal\n' + '\n' + 'mechanisms of the machine.', id: 5 },
			{ text: 'F. Winds thread onto the bobbin.', id: 6 },
			{ text: 'G. Controls the position of the presser foot,\n' + '\n' + 'raising and lowering it.', id: 7 },
			{ text: 'H. Holds the sewing machine needle\n' + '\n' + 'securely in place.', id: 8 },
			{ text: 'I. Holds the spool of thread during\n' + '\n' + 'stitching.', id: 9 },
			{ text: 'J. Controls the length of each stitch.', id: 10 },
			{ text: 'K. Helps guide the upper thread from the\n' + '\n' + 'spool to the needle.', id: 11 },
			{ text: 'L. Provides support to the fabric as it\n' + 'moves through the sewing machine.', id: 12 },
			{ text: 'M. Primary tool for creating stitches in the\n' + '\n' + 'fabric.', id: 13 },
			{ text: 'N. Works with the presser foot to move\n' + '\n' + 'fabric under the needle.', id: 14 },
			{
				text: 'O. The lower thread that works together\n' + 'with the upper thread to create stitches.',
				id: 15,
			},
			{ text: 'P. Allows control of the sewing speed by\n' + '\n' + 'pressing with the foot.', id: 16 },
			{ text: "Q. Protects the sewing machine's internal\n" + '\n' + 'mechanisms and fabric.', id: 17 },
			{ text: "R. Adjusts the needle's movement\n" + '\n' + 'manually to raise or lower it.', id: 18 },
			{ text: 'S. Securely holds the bobbin thread in\n' + '\n' + 'place.', id: 19 },
			{ text: 'T. A second thread guide for better control\n' + '\n' + 'of the upper thread.', id: 20 },
		],
	},
]
